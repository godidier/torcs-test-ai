...
class v2d {
	public: 
		...
		/* operators */ 
		v2d& operator=(const v2d &src); /* assignement */
		v2d operator+(const v2d &src) const; /* addition */
		v2d operator-(void) const; /* negation */
		v2d operator-(const v2d &src) const; /* substraction */
...
/* compute *this - src (vector substraction) */
inline v2d v2d::operator-(const v2d &src) const
{
	return v2d(x - src.x, y - src.y);
}
...
/* compute cosine between vectors *this-c and p2-c */
